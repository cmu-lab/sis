...
void setup() {
 ...
 Slider s2 = (Slider)controlP5.getController("depthSlider"); //Get a handle to the new slider
 ...
 s2 = (Slider)controlP5.getController("jitterSlider"); //Get a handle to the new slider
 s2.setLabel("Jitter");
 keyPressed();
}
